    ...
    >
      ...
      <div className='relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl'>
        ...
        <motion.h2
          ...
          className='font-bold text-3xl text-center text-white sm:text-4xl'
        >
          My Projects
        </motion.h2>
        <motion.p
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className='relative z-10 flex flex-col flex-grow p-4 sm:p-6 text-white'>
                ...
                <p className='flex-grow mt-3 text-sm sm:text-base'>
                  {project.description}
                </p>
              ...
              {/* Action Buttons */}
              <div className='bottom-0 left-0 z-50 absolute flex justify-between items-center bg-slate-800 bg-opacity-90 px-4 sm:px-6 py-2 w-full'>
                <a
